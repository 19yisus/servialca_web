...
$Pdf->Cell(100, 10, "");
$Pdf->Cell(48, 13, "Contrato NRO: 00000" . $datos[0]["poliza_id"] . " - " . $renovacion);
$Pdf->Ln(1);
$Pdf->Cell(85, 10, "");
$Pdf->SetFont('Arial', 'B', 10);
...
$Pdf->Ln(5);
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(22, 80, "Contratante: ");
$Pdf->SetFont('Arial', '', 10);
$Pdf->Cell(94, 80, "" . utf8_decode($datos[0]["cliente_nombre"]) . " " . utf8_decode($datos[0]["cliente_apellido"]));
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(13, 80, "CI/RIF: ");
$Pdf->SetFont('Arial', '', 10);
...
$Pdf->Ln(5);
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(18, 80, "Ser. Carr.: ");
$Pdf->SetFont('Arial', '', 10);
$Pdf->Cell(82, 80, "" . $datos[0]["vehiculo_serialCarroceria"]);
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(21, 80, "Ser. Motor.: ");
$Pdf->SetFont('Arial', '', 10);
$Pdf->Cell(60, 80, "" . $datos[0]["vehiculo_serialMotor"]);
$Pdf->Ln(5);
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(12, 80, "Placa: ");
$Pdf->SetFont('Arial', '', 10);
$Pdf->Cell(88, 80, "" . $datos[0]["vehiculo_placa"]);
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(10, 80, "Tipo: ");
$Pdf->SetFont('Arial', '', 10);
...
$Pdf->Cell(60, 70, "" . $datos[0]["cobertura_danoCosas"] + $datos[0]["cobertura_danoPersonas"]);
$Pdf->Ln(8);
$Pdf->SetFont('Arial', '', 10);
...
$Pdf->Cell(60, 70, "" . $datos[0]["cobertura_fianzaCuanti"] + $datos[0]["cobertura_asistenciaLegal"]);
$Pdf->Ln(6);
$Pdf->SetFont('Arial', '', 10);
...
$Pdf->Cell(60, 70, "" . $datos[0]["cobertura_muerte"] + $datos[0]["cobertura_invalidez"] + $datos[0]["cobertura_gastosMedicos"]);
$Pdf->Ln(6);
$Pdf->SetFont('Arial', '', 10);
