...
export default function useTableFijo(records, headCells, filterFn, heightTabla) {
    ...
    const TblContainer = props => (
        <Paper className={classes.root}>
            <TableContainer style={{height: heightTabla}}>
            ...
            <TableRow>
                {
                  headCells.map(headCell => (
                    <TableCell key={headCell.id} style={{ color: headCell.color, fontSize: headCell.fontSize, background: '#3b8eed', textAlign: headCell.textAlign, fontWeight: "bold"/*, minWidth:headCell.width*/ }} width={headCell.width} 
