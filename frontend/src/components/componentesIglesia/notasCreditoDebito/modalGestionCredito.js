...
export const ModalCredito = (props) => {
  ...
  const onChangeValidar = () => {
    ...
    if(txtRefer.current.value === ''){
      ...
      setMensaje({
        mostrar: true,
        titulo: "Notificación",
        texto: "Debe seleccionar el tipo de Credito",
        icono: "informacion",
      });
      ...
      setMensaje({
        mostrar: true,
        titulo: "Notificación",
        texto: "Debe seleccionar el tipo de Entrada",
        icono: "informacion",
      });
      ...
      setMensaje({
        mostrar: true,
        titulo: "Notificación",
        texto: "Debe ingresar el Monto de la entrada",
        icono: "informacion",
      });
    ...
    <Modal
      ...
      onShow={() => {
        ...
        if (props.operacion !== 1) {
          txtCedula.current.value = props.nota ? props.nota.idnotacredito : ''
          txtRefer.current.value = props.nota ? props.nota.referencia.trim() : ''
          cmbTipo.current.value  = props.nota ? props.nota.tipo_credito : '' 
          cmbTipo2.current.value = props.nota && props.nota.tipo_entrada ? props.nota.tipo_entrada : ''
          txtConcepto.current.value = props.nota ? props.nota.concptocredito.trim() : ''
          txtMonto.current.value =  props.nota ? formatMoneda(props.nota.montocredito.toString().replace(',', '').replace('.', ','), ',', '.', 2) : '0,00'
      ...
      <Modal.Body style={{ color: "rgb(106, 115, 123)" }}>
        <div className="col-md-12 row  d-flex justify-content-between">
          ...
          <div class="input-group input-group-sm mb-2 col-md-4">
            ...
            >
              <option value="">Seleccione</option>
              <option value="0">E.B.D</option>
              <option value="1">Ofrendas</option>
              <option value="2">Diesmoz</option>
