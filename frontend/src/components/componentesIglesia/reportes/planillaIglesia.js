...
import MyDocument from './reporteiglesia';
 ...
 const hola = 'hola'
  ...
  return (
    <div style={{ height: '80%', width: '100%' }}>
      <div className="row col-md-12 py-2 px-2" style={{margin:0}}>
        <div className='row col-md-12 card py-2' style={{margin:0}}>
          <div className='card-body col-md-12 py-3'>
              <div className='col-md-12 row'>
                  <div className='col-md-3'>
                     <div className='col-md-12 mx-auto bg-primary'>
                         hola
                     </div>
                  </div>
                  <div className='col-md-9'>
                     <div className='col-md-12' id='pdf'>
                       <PDFViewer style={{height:'70vh', width:'100%'}}>
                            <MyDocument hola={hola} />
                        </PDFViewer> 
                     </div>
                  </div>
              </div>
...
export default PlanillaIglesia;