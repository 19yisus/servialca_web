...
function TablaLicencia() {
  ...
  const headCells = [
    ...
    { label: "Apellido", textAlign: "center",backgroundColor:'#e70101bf',color:'white' },
    { label: "Cédula", textAlign: "center",backgroundColor:'#e70101bf',color:'white' },
    ...
    { label: "Licencia", textAlign: "center",backgroundColor:'#e70101bf',color:'white' },
    { label: "Otras licencias", textAlign: "center",backgroundColor:'#e70101bf',color:'white' },
    { label: "Abonado", textAlign: "center",backgroundColor:'#e70101bf',color:'white' },
    { label: "Restante", textAlign: "center",backgroundColor:'#e70101bf',color:'white' },
      ...
      fn: items => {
        if (target.value === "")
          ...
          return items.filter(x => {
            if ((x.licencia_id !== null ? String(x.licencia_id).includes(target.value) : 0)
                ...
                <TableBody >
                  {
                    records && recordsAfterPagingAndSorting().map((item, index) => (
                      <TableRow key={index} style={{ padding: "0" }}>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_id}</TableCell> 
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.cliente_nombre}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.cliente_apellido}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.cliente_cedula}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_correo}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_sangre}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_licencia}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_licenciaRestante}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_abonado}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center' }}>{item.licencia_restante}</TableCell>
                        <TableCell className='align-baseline' style={{ textAlign: "center", alignItems: 'center',width:130 }}>
                          <button onClick={gestionarBanco(2, item.licencia_id)}  className="btn btn-sm mx-1 btn-warning rounded-circle"><i className="fa fa-edit"></i> </button>
                          <button onClick={gestionarBanco(3, item.licencia_id)}  className="btn btn-sm mx-1 btn-danger rounded-circle"><i className="fa fa-trash"></i> </button>
                        </TableCell>
                      </TableRow>
                    ))
                  }
